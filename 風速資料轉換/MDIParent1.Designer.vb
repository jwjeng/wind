...
Partial Class MDIParent1
    ...
    Private Sub InitializeComponent()
        ...
        Me.HelpToolStripButton.Text = "說明"
        '
        'ToolStripSeparator2
        '
        ...
        Me.PrintPreviewToolStripButton.Text = "預覽列印"
        '
        ...
        Me.PrintToolStripButton.Text = "列印"
        '
        'NewToolStripButton
        '
        ...
        Me.SaveToolStripButton.Text = "儲存"
        '
        'ToolStripSeparator1
        '
